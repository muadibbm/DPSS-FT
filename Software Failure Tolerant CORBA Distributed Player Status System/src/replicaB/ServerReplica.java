		 ...
		 try {
				...
				while (true) {							
					...
					if (dataRecieved.contains("online")) {
						...
						bufferStat = ("1" + Parameters.UDP_PARSER + Parameters.RB_NAME + globalSystemSat  + Parameters.UDP_END_PARSE).getBytes();						
					...
					//send 2 UDP messages to the other 2 servers	
						...
						//methodAcknowledgmentStr = methodAcknowledgmentStr.replace("//", "/");
